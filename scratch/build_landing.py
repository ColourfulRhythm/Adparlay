...
# Fix styles quote issues (e.g. fontFamily: ''Outfit',sans-serif')
# Actually simpler: just replace ''Outfit' with \"'Outfit'\" or similar.
# We can just change the wrapping quotes in the style objects to double quotes.
jsx = re.sub(r": '([^']*'[^']*)+'", lambda m: ": \"" + m.group(0)[3:-1] + "\"", jsx)
jsx = jsx.replace("''Outfit',sans-serif'", '"\'Outfit\',sans-serif"')
jsx = jsx.replace("''Epilogue',sans-serif'", '"\'Epilogue\',sans-serif"')
