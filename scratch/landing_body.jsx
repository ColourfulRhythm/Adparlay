...
<section id="pricing">
  ...
  <div className="reveal">
    <div className="pricing-toggle">
      <button className="toggle-btn active" id="btn-monthly" onclick="setPricing('monthly')">Monthly</button>
      <button className="toggle-btn" id="btn-annual" onclick="setPricing('annual')">Annual (Save 20%)</button>
    </div>
  </div>
  <div className="pricing-grid reveal">
    <div className="price-card">
      ...
      <p className="price-billing" id="billing-free">Billed Monthly</p>
    ...
    <div className="price-card popular">
      ...
      <div className="price-amount"><span className="price-currency">₦</span><span className="price-val" id="premium-price">2,099</span><span className="price-period">/mo</span></div>
      <p className="price-billing" id="billing-premium">Billed Monthly</p>
      <ul className="price-features">
      ...
      <button className="btn-plan btn-purple">Start Premium Trial</button>
    </div>
  </div>
</section>
...
<section className="cta-section">
  ...
  <button className="btn-cta reveal" style={{ margin: '0 auto' }}>
